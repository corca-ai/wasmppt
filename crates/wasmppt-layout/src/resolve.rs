...
use crate::{
    ChartGrouping, ChartKind, CustomPath, ElementKind, EmbeddedFontResource, EmbeddedFontStyle,
    EmuPoint, EmuSize, Fill, GradientStop, GroupTransform, ImageCrop, LayoutError, LineEnd,
    OuterShadow, PathCommand, Placeholder, PreservedFeature, PresetGeometry, PropertyProvenance,
    ResolutionTrace, ResolveDiagnostic, ResolveDiagnosticCode, ResolveOutput, ResolvedBulletImage,
    ResolvedChart, ResolvedElement, ResolvedParagraph, ResolvedSlide, ResolvedTable,
    ResolvedTableCell, ResolvedTableRow, ResolvedTextFrame, ResolvedTextRun, ResolvedTextStyle,
    ResolvedTextTab, RgbaColor, SourceLevel, Stroke, TableCellBorders, TextAlignment, TextAutofit,
    TextDirection, TextFlow, TextFontAlignment, TextGlow, TextSpacing, TextTabAlignment,
    TextVerticalAlignment, TextWarp, Transform, plain_i64,
};

mod chart;
mod color;

use chart::parse_chart;
#[cfg(test)]
